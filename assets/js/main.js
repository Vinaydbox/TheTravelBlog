...
users = [
  {
    name: "Ashfaq",
    email: "ashfaqpasha66@gmail.com",
    password: "12345"
  },
  {
      name:"Vinay",
      email:"kasala.vinay@gmail.com",
      password: "12345"
  }
]

login.onclick = function validation() {
  console.log("on click function validation");
    if(formvalidate()){
        console.log("INSIDE");
        loginpage.classList.remove("d-block");
        loginpage.classList.add("d-none");
        welcomemsg.innerHTML = "<h2>Welcome, Click here to explore </h2>"
    }
    else{
      console.log("wrong");
    }
